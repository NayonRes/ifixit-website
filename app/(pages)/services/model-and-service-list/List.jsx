          ...
          {!modelLoading &&
            ...
            modelList.map((item) => (
              <Link
                ...
                //     /\s+/g,
                //     "-"
                //   )}/service-list?device_id=${device_id}&model_id=${
                //   item?._id
              ...
              >
                <Typography
                  ...
                  sx={{
                    ...
                    py: "2px",
                    borderLeft:
                      hash === `#!${item?.endpoint}` && "3px solid #F57042",
                    fontWeight: 600,
                  }}
                >
                  {item?.name}
...
const ServiceList = memo(({ serviceList, serviceLoading, modelList }) => {
  return (
    <Box>
          ...
          serviceList
            ...
            .map((item) => (
              <Grid
                ...
                key={item._id}
              >
                <ServiceCard item={item} modelList={modelList} />
              </Grid>
            ))}
      </Grid>
      <Box>
